...
expected_columns1 = ['toCoordinates', 'roundTrip', 'seatsTaken', 'returnDate', 'seatsMax', 'type', 'date', 'from', 'to', 'riders', 'sameGender', 'fromCoordinates']
expected_columns2 = ['numOfRatings', 'lastName', 'firstName', 'comments', 'rating', 'pastTrips', 'gender', 'upcomingTrips', 'coordinates', 'email']

def read_data(collection_name, expected_columns):
...
df_trips = read_data(u'trips', expected_columns1)

df_users = read_data(u'users', expected_columns2)



users_coord = df_users['coordinates']
